Contributing to REA Core
============================

The REA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the REA Core project, and is not to be
confused with overall REA Network Protocol consensus changes.

Whether a pull request is merged into REA Core rests with the project merge
...
Patches that change REA consensus rules are considerably more involved than
...
Where a patch set proposes to change the REA consensus, it must have been
...
The project leader is the release manager for each REA Core release.
