...
RESOURCES += src/qt/rea.qrc src/qt/rea_locale.qrc

TRANSLATIONS += src/qt/locale/rea_bg.ts \
                src/qt/locale/rea_de.ts \
                src/qt/locale/rea_en.ts \
                src/qt/locale/rea_es.ts \
                src/qt/locale/rea_fi.ts \
                src/qt/locale/rea_fr.ts \
                src/qt/locale/rea_it.ts \
                src/qt/locale/rea_ja.ts \
                src/qt/locale/rea_pl.ts \
                src/qt/locale/rea_pt.ts \
                src/qt/locale/rea_ru.ts \
                src/qt/locale/rea_sk.ts \
                src/qt/locale/rea_sv.ts \
                src/qt/locale/rea_vi.ts \
                src/qt/locale/rea_zh_CN.ts \
                src/qt/locale/rea_zh_TW.ts
