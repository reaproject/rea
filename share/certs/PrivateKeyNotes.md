...
For Windows, the private key was generated by Firerea running on Gavin's main work machine.
The key and certificate were exported into a separate, passphrase-protected PKCS#12 file, and
then deleted from Firerea's keystore. The exported file is used to sign the Windows setup.exe.
