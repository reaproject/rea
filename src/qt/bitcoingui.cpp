                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("REA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a REA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rea: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About REA Core"), this);
    aboutAction->setStatusTip(tr("Show information about REA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for REA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your REA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified REA addresses"));
    ...
    openAction->setStatusTip(tr("Open a REA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the REA Core help message to get a list with possible REA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("REA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to REA network", "", count));
}
...
{
    QString strTitle = tr("REA Core"); // default title
