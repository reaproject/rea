...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Rea features */
        {"rea", "masternode", &masternode, true, true, false},
        {"rea", "listmasternodes", &listmasternodes, true, true, false},
        {"rea", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rea", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rea", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rea", "masternodedebug", &masternodedebug, true, true, false},
        {"rea", "startmasternode", &startmasternode, true, true, false},
        {"rea", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rea", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rea", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rea", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rea", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rea", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rea", "mnbudget", &mnbudget, true, true, false},
        {"rea", "preparebudget", &preparebudget, true, true, false},
        {"rea", "submitbudget", &submitbudget, true, true, false},
        {"rea", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rea", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rea", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rea", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rea", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rea", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rea", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rea", "checkbudgets", &checkbudgets, true, true, false},
        {"rea", "mnsync", &mnsync, true, true, false},
        {"rea", "spork", &spork, true, true, false},
        {"rea", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"rea", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use read, or the -server option to rea-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> rea-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36393/\n";
}
