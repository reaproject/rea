...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 1050000;
...
static const char * devAddr="Rp8YxjzvNPeocjmifkyCZNQz5X2kEwdMxH"; //dev address here
static const int devPaymentForce=132485; //dev payment forced
