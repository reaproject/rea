...
This mechanism has been integrated into Bitcore-Node-REA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/reaproject/rea/insight-api-rea#web-socket-api](https://github.com/reaproject/rea/insight-api-rea#web-socket-api) 
* API: [https://github.com/reaproject/rea/insight-api-rea#swifttx-transactions](https://github.com/reaproject/rea/insight-api-rea#swifttx-transactions) 
...
By default, the REA Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the REA Core daemon:
