...
In order to support loading of multiple wallets in rea-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rea.cpp.
...
Changes to rea.cpp
----------------------
rea.cpp is the entry point into rea-qt, and as such, will require some minor modifications to provide hooks for
